...
const stats = [
  { label: "Total customers", value: 1400, sub: "+20.1% from last month" },
  { label: "Active booking", value: 700, sub: "+15% from last month" },
  { label: "New customer (Last month)", value: 150, sub: "+5% from last month" },
  { label: "Avg. booking value", value: "$60.80", sub: "+1% from last month" },
];

const customers = [
  { name: "Temidayo Faluyi", email: "Termi@gmail.com", phone: "+234 806 5017 856", bookings: 7, lastBooking: "2025/07/14", status: "Active" },
  { name: "Temidayo Faluyi", email: "Termi@gmail.com", phone: "+234 806 5017 856", bookings: 1, lastBooking: "2025/07/14", status: "New" },
  { name: "Temidayo Faluyi", email: "Termi@gmail.com", phone: "+234 806 5017 856", bookings: 15, lastBooking: "2025/07/14", status: "Inactive" },
  { name: "Temidayo Faluyi", email: "Termi@gmail.com", phone: "+234 806 5017 856", bookings: 7, lastBooking: "2025/07/14", status: "Active" },
  { name: "Temidayo Faluyi", email: "Termi@gmail.com", phone: "+234 806 5017 856", bookings: 1, lastBooking: "2025/07/14", status: "New" },
  { name: "Temidayo Faluyi", email: "Termi@gmail.com", phone: "+234 806 5017 856", bookings: 15, lastBooking: "2025/07/14", status: "Inactive" },
];
